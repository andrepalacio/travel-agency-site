...
export function CruiseCard({
  ...
  return (
    ...
    >
      <div
        className={`flex flex-col ${isEven ? "md:flex-row" : "md:flex-row-reverse"} bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 min-h-[500px]`}
      >
        ...
        <div className="w-full md:w-1/2 p-12 md:p-20 flex flex-col justify-center bg-slate-50/50">
          ...
          <h2 className="text-4xl font-bold tracking-tighter uppercase mb-6 italic">
            {data.name}
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              ...
              onClick={() => (globalThis.location.href = data.externalLink)}
            >
              {data.ctaText}
