...
export const leadAlertTemplate = (data: any) => `
  <div style="font-family: sans-serif; color: #333; max-width: 600px; border: 1px solid #eee; padding: 20px;">
    ...
    <table style="width: 100%; border-collapse: collapse;">
      ...
      <tr><td style="padding: 8px 0; font-weight: bold;">Interés:</td><td>${data.interesSeleccionado} (${data.tipoInteres})</td></tr>
...
export const brochureCustomerTemplate = (nombre: string, brochureName: string) => `
  <div style="font-family: sans-serif; color: #333; max-width: 600px; text-align: center; padding: 40px; background-color: #f9f9f9;">
    ...
    <div style="margin: 30px 0;">
      <a href="https://tu-web.com/downloads/${brochureName}.pdf" 
